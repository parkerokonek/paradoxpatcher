...
impl MergerError {
    fn error_text(&self) -> String {
        match self {
            ...
            MergerError::LoadRegisteredModError => String::from("Could not load files for previously registered mod."),
    ...
    fn variant_name(&self) -> String {
        match self {
            ...
            MergerError::LoadRegisteredModError => "Load Registered Mod Error",
